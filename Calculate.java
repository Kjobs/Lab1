...
public class Calculate
{
  ...
  public static void main(String[] args) throws IOException 
  {
    ...
    {
      exp = Calculate.expression(exp);
      System.out.println(exp);

      //input the simplify expression
      String strexp = Calobject.GetString();
      String SimplifyExp = Calculate.expression(strexp);
      ...
      {
        SimpExp = Calculate.simplify(exp,SimplifyExp);
      ...
      String DervativeExp = Calculate.expression(strexp);
      ...
      {
        DerExp = Calculate.derivative(exp,DervativeExp);

	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='education' />" class="active"><span>教育</span></a></li>
			...
			<div id="sidebar">
				...
				<div class="box">					
					...
					<div class="box-content">
						...
						<div class="sort">
							<label>SORT BY</label>
							<form action="education.action" method="post">   

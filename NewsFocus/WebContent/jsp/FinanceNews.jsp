	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='finance' />" class="active"><span>财经</span></a></li>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th>Date</th>
								<th>Source From</th>
								<th width="110" class="ac">Collect News</th>
								
							</tr>
							<s:iterator value="FinanceNewsList">
							<tr>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<div class="sort">
							<label>SORT BY</label>
							<form action="finance.action" method="post">   

	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='car' />" class="active"><span>汽车</span></a></li>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<th>Date</th>
								<th>Source From</th>
								<th width="90px" class="ac">Collect News</th>
							</tr>
							<s:iterator value="CarNewsList">
							<tr>
								<td><h3><a href="<s:property value='Link' />"><s:property value='Title' /></a></h3></td>
								<td><s:property value="Date" /></td>
								<td><s:property value="Source" /></td>
								<td>关注&nbsp;&nbsp;&nbsp;<a class="ico del" onclick="this.innerHTML=parseInt(this.innerHTML)+1;document.theform.submit();alert('123');"><s:property value='LikeNum' /></a></td>
							</tr>
							<form name="theform" action="AddLikeNum.action" method="post">
								<input type="hidden" name="publicity" value="<s:property value='LikeNum' />">
							</form>
							</s:iterator>
						</table>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<div class="sort">
							<label>SORT BY</label>
							<form action="car.action" method="post">   

	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='entertainment' />" class="active"><span>娱乐</span></a></li>
				...
				<div class="box">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="EntToutiaoList">
							<tr>
				...
				<div class="box">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="EntYaowenList">
							<tr>
								<td><h3><a href="<s:property value='Link' />"><s:property value='Title' /></a></h3></td>
								<td><s:property value="Date" /></td>
								<td><s:property value="Source" /></td>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">						
						...
						<div class="sort">
							<label>SORT BY</label>
							<form action="entertainment.action" method="post">   

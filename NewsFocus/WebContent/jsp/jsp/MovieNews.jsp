	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='movie' />" class="active"><span>影视</span></a></li>
			</ul>
		</div>
		<!-- End Main Nav -->
	</div>

...
<div id="header">
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    <li><a href="<s:url action='main' />" class="active"><span>今日要闻</span></a></li>
			...
			<div id="sidebar">				
				...
				<div class="box">					
					...
					<div class="box-content">						
						...
						<div class="sort">
							<label>Sort by</label>
							<select class="field" id="sort" onchange="main.action" name="OrderType" >
								<option value="title">Title</option>
								<option value="news_date">Date</option>

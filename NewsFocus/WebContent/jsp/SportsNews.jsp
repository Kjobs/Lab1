	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='sports' />" class="active"><span>体育</span></a></li>
				...
				<div class="box">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="SportsNewsList">
							<tr>
				...
				<div class="box">
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator value="BasketballNews">
							<tr>
								<td><h3><a href="<s:property value='Link' />"><s:property value='Title' /></a></h3></td>
								<td><s:property value="Date" /></td>
								<td><s:property value="Source" /></td>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<div class="sort">
							<label>SORT BY</label>
							<form action="sports.action" method="post">   

	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="<s:url action='war' />" class="active"><span>军事</span></a></li>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<div class="sort">
							<label>SORT BY</label>
							<form action="war.action" method="post">   
